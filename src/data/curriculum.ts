  ...
  modules: [
    ...
    },
    {
      ...
      lessons: [
        {
          id: 'L17-01',
          title: 'AI Coding 的能力边界：什么该交给 AI，什么必须自己写',
          summary: '先划边界再谈效率。AI 擅长的、勉强能做的、和你千万别交出去的三类工作。',
          duration: 40,
          type: '理论',
          objectives: [
            '识别 AI Coding 的三类任务边界与失败模式',
            '理解"生成速度"与"维护成本"的错位',
            '建立个人的委托清单：哪些环节必须留在自己手里',
          ],
          tags: ['AI Coding', 'Cursor', 'Claude Code', '能力边界'],
          prerequisites: ['L14-02'],
          competency: '工程判断',
        },
        {
          id: 'L17-02',
          title: '从想法到方案：用 AI 做头脑风暴与可行性验证',
          summary: '把"我想做个东西"变成一份能开工的技术方案，并在写第一行代码前否掉坏点子。',
          duration: 35,
          type: '实战',
          objectives: [
            '用结构化提问把模糊想法逼成可执行方案',
            '用 AI 做竞品扫描与技术可行性预研',
            '识别 AI 在方案阶段的附和倾向并对抗它',
          ],
          tags: ['需求分析', 'Brainstorming', '技术选型'],
          prerequisites: ['L02-01'],
          competency: '产品思维',
        },
        {
          id: 'L17-03',
          title: '规格驱动开发：把想法写成 AI 能执行的规格',
          summary: '模糊需求进、垃圾代码出。写规格是 AI Coding 里回报率最高的一件事。',
          duration: 40,
          type: '实战',
          objectives: [
            '掌握可执行规格的结构：输入/输出/边界/验收',
            '用测试用例作为规格的可执行形式',
            '建立"规格→实现→验收"的闭环工作流',
          ],
          tags: ['Spec-Driven', 'TDD', 'Prompt 工程'],
          prerequisites: ['L02-04'],
          competency: '工程方法',
        },
        {
          id: 'L17-04',
          title: '代码库上下文工程：让 AI 真正理解你的项目',
          summary: '同样的模型，给对上下文和给错上下文，产出质量差一个数量级。',
          duration: 45,
          type: '实战',
          objectives: [
            '设计项目级约定文件（约定、边界、禁区）',
            '为大型代码库做检索式上下文供给',
            '识别上下文污染导致的风格漂移与重复造轮子',
          ],
          tags: ['Context Engineering', 'Codebase', 'RAG'],
          prerequisites: ['L03-02', 'L04-04'],
          competency: '上下文工程',
        },
        {
          id: 'L17-05',
          title: 'AI 生成生产级前端 UI（上）：设计系统与组件约束',
          summary: 'AI 默认产出的是 demo 级 UI。把设计系统喂给它，才能得到能上线的界面。',
          duration: 45,
          type: '实战',
          objectives: [
            '把设计 token 与组件规范固化成 AI 可消费的约束',
            '区分"看起来能用"与"生产可用"的界面差距',
            '用组件库与示例约束 AI 的视觉产出一致性',
          ],
          tags: ['前端', 'Design System', 'Tailwind', 'UI'],
          prerequisites: ['L10-05'],
          competency: '前端工程',
        },
        {
          id: 'L17-06',
          title: 'AI 生成生产级前端 UI（下）：状态、可访问性与响应式',
          summary: '生产级 UI 的差距全在"非happy path"：加载、空、错误、超长、离线、无鼠标。',
          duration: 45,
          type: '实战',
          objectives: [
            '用状态矩阵逼 AI 补齐加载/空/错误/超限等边界态',
            '把可访问性与响应式写进生成约束而非事后补丁',
            '建立 UI 产出的自检清单与验收标准',
          ],
          tags: ['前端', 'A11y', '响应式', 'UI 状态'],
          prerequisites: ['L17-05'],
          competency: '前端工程',
        },
        {
          id: 'L17-07',
          title: 'AI 辅助测试与重构：让改动可验证',
          summary: '一个人改代码最怕的不是写错，是改坏了没人发现。测试是独立开发者的安全带。',
          duration: 40,
          type: '实战',
          objectives: [
            '用 AI 补齐存量代码的特征测试（characterization test）',
            '在有测试网的前提下做大范围重构',
            '识别 AI 生成测试的典型缺陷：只测 happy path、断言过弱',
          ],
          tags: ['测试', '重构', 'pytest'],
          prerequisites: ['L13-07'],
          competency: '质量保障',
        },
        {
          id: 'L17-08',
          title: '一人公司的 CI/CD 与发布流水线',
          summary: '没有运维同事，流水线就是你的运维同事。从提交到上线全自动。',
          duration: 40,
          type: '实战',
          objectives: [
            '搭建覆盖 lint/测试/构建/部署的最小可用流水线',
            '设计一个人也能安全操作的回滚路径',
            '把发布这件事从"需要勇气"变成"点一下"',
          ],
          tags: ['CI/CD', 'GitHub Actions', '部署'],
          prerequisites: ['L15-05'],
          competency: '工程化',
        },
        {
          id: 'L17-09',
          title: 'AI 生成代码的质量门禁与技术债管理',
          summary: 'AI 让写代码变便宜，于是技术债积累得也更快。门禁是唯一的刹车。',
          duration: 35,
          type: '理论',
          objectives: [
            '建立 AI 产出代码的准入门禁（复杂度、重复率、依赖新增）',
            '识别 AI 特有的技术债：重复实现、过度抽象、幽灵依赖',
            '设计一个人可持续的债务偿还节奏',
          ],
          tags: ['代码质量', '技术债', 'Lint'],
          prerequisites: ['L17-07'],
          competency: '工程判断',
        },
        {
          id: 'L17-10',
          title: '独立开发者的工具链与成本控制',
          summary: '订阅费、API 费、云费用——一个人的工具链账单很容易悄悄超过收入。',
          duration: 35,
          type: '理论',
          objectives: [
            '盘点独立开发全流程的工具链与真实月成本',
    ...
    },
    {
      ...
      lessons: [
        ...
        },
        {
          ...
          type: '实战',
          objectives: [
            '打通注册/登录/订阅/续费/退款的最小闭环',
            '正确处理 webhook 幂等与对账',
            '设计订阅状态与功能权限的映射',
          ],
          tags: ['支付', '订阅', 'Webhook', '账号体系'],
          prerequisites: ['L17-08'],
          competency: '系统实现',
        },
        {
        ...
        },
        {
          ...
          type: '理论',
          objectives: [
            '梳理 AI 产品常见的合规触点与信息披露义务',
            '设计数据最小化与删除路径',
            '识别哪些问题必须找专业人士而不是自己拍板',
          ],
          tags: ['合规', '隐私', '风险管理'],
    ...
    },
    {
      ...
      description:
        '产品上线只是开始。这一章讲冷启动、内容与搜索、数据驱动增长、一个人怎么做用户支持、' +
      ...
      lessons: [
        ...
        },
        {
          ...
          type: '理论',
          objectives: [
            '围绕真实搜索意图规划内容而非围绕关键词堆量',
            '理解 AI 生成内容在搜索侧的机会与风险',
            '建立内容→产品的转化路径',
          ],
          tags: ['SEO', '内容营销', '获客'],
        ...
        },
        {
          ...
          type: '实战',
          objectives: [
            '识别运营流程中适合自动化的环节与必须留人的环节',
            '搭建监控/报表/支持初筛的运营 Agent',
...
export const stages = [
  ...
  },
  {
    ...
    detail: 'Harness 工程化，记忆系统，代码沙箱，框架编排',
  },
  {
    id: 5,
    name: '多智能体与多模态篇',
