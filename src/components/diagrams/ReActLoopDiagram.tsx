...
const layers: DiagramLayer[] = [
  { id: 'agent', label: 'Agent 推理层', y: 2, height: 38, color: 'brand' },
  { id: 'env', label: '外部环境 / 工具', y: 42, height: 28, color: 'amber' },
]

const nodes: DiagramNode[] = [
  { id: 'thought', label: 'Thought', x: 5, y: 15, color: 'brand' },
  { id: 'action', label: 'Action', x: 38, y: 15, color: 'brand' },
  { id: 'obs', label: 'Observation', x: 71, y: 15, color: 'brand' },
  { id: 'tool', label: 'Tool\nCall', x: 38, y: 55, color: 'amber' },
  { id: 'answer', label: 'Answer', x: 88, y: 15, color: 'emerald' },
]
