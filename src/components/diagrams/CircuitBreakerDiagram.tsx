...
const nodes: DiagramNode[] = [
  { id: 'closed', label: 'Closed\n正常', x: 5, y: 30, color: 'emerald' },
  { id: 'open', label: 'Open\n熔断', x: 38, y: 30, color: 'danger' },
  { id: 'half', label: 'Half-Open\n探测', x: 71, y: 30, color: 'amber' },
  { id: 'fail', label: '故障\n阈值触发', x: 20, y: 8, color: 'danger' },
  { id: 'timeout', label: '超时\n冷却到期', x: 55, y: 8, color: 'amber' },
  { id: 'success', label: '探测\n成功', x: 55, y: 55, color: 'emerald' },
  { id: 'refail', label: '探测\n失败', x: 20, y: 55, color: 'danger' },
]
