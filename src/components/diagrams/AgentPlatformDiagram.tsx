...
const layers: DiagramLayer[] = [
  { id: 'access', label: '接入层 —— 多租户 + API + 权限', y: 8, height: 10, color: 'fuchsia' },
  { id: 'orchestration', label: '编排层 —— Agent 生命周期管理', y: 22, height: 10, color: 'brand' },
  { id: 'tools', label: '工具生态层 —— MCP + 插件市场', y: 36, height: 10, color: 'amber' },
  { id: 'data', label: '数据层 —— 隔离 + 向量库 + 审计', y: 50, height: 10, color: 'emerald' },
  { id: 'infra', label: '基础设施层 —— 计算 + 网络 + 安全', y: 64, height: 10, color: 'ink' },
]

const nodes: DiagramNode[] = [
  { id: 'tenant_a', label: '租户 A', x: 5, y: 10, color: 'fuchsia' },
  { id: 'tenant_b', label: '租户 B', x: 50, y: 10, color: 'fuchsia' },
  { id: 'gw', label: 'API\n网关', x: 27, y: 10, color: 'fuchsia' },
  { id: 'agent_mgr', label: 'Agent\n管理器', x: 27, y: 24, color: 'brand' },
  { id: 'orchestrator', label: '编排\n引擎', x: 50, y: 24, color: 'brand' },
  { id: 'registry', label: '工具\n注册表', x: 27, y: 38, color: 'amber' },
  { id: 'mcp_gw', label: 'MCP\n网关', x: 50, y: 38, color: 'amber' },
  { id: 'isolate', label: '数据\n隔离', x: 27, y: 52, color: 'emerald' },
  { id: 'audit', label: '审计\n日志', x: 50, y: 52, color: 'emerald' },
  { id: 'compute', label: '计算\n资源池', x: 27, y: 66, color: 'ink' },
  { id: 'billing', label: '计费\n计量', x: 50, y: 66, color: 'ink' },
  { id: 'auth_svc', label: '权限\n服务', x: 73, y: 10, color: 'fuchsia' },
  { id: 'monitor', label: '平台\n监控', x: 73, y: 24, color: 'brand' },
]
